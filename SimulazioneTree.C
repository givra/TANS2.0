 ...
 bool multipleScatt = 1;		// 0 = false, 1 = true
  ...
  // ______________grafico 3d intersezioni_______________
	...
	for(int evento = 0; evento < numeroeventi; evento++){
	    ...
	    //QUESTO FORSE RALLENTA?? si potrebbe fare funzione che genera nuovo vertice e molt senza dover creare nuovo oggetto
	    //inoltre anche funzione che sputa subito X Y Z
	    //FATTO
		    vertice0.NewVertex();
